...
export default function AddShipTo({ navigation, route }) {
  const { shipToDetails, onSave } = route.params || {};
    ...
    const gstTreatmentTypes = [
      ...
      { label: "Registered Business", value: "registered_regular" },
        ...
        <View style={styles.header}>
          <SafeAreaView edges={["top"]}>
            <View style={styles.headerContent}>
              ...
              <Text style={styles.headerTitle}>Ship To Details</Text>
              <TouchableOpacity
                onPress={handleSave}
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={styles.saveButtonText}>Save Ship To Details</Text>
            </TouchableOpacity>
